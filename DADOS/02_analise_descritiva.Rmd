...
main = "Gráfico X: Acertos por Área do ENEM (GO)",
ylab = "Acertos",
...
boxplot(notas_enem,
main = "Gráfico X: Notas por Área do ENEM (GO)",
ylab = "Nota",
xlab = "Área de Conhecimento",
names = rotulos_areas,
col = cores_areas,
...
boxplot(dados_enem$NU_NOTA_RED ~ dados_enem$TP_DEPENDENCIA_ADM_ESC,
        main="Gráfico 6: Nota de Redação por Tipo de Escola",
...
plot(dados_enem$NU_NOTA_CN, dados_enem$NU_NOTA_MT,
     main="Gráfico 7: Regressão Linear - Nota Mat. vs. Nota CN",
...
O objetivo desta análise é verificar se o desempenho do participante em **Linguagens e Códigos (ACERTOS_LC)** pode ser usado para prever sua **nota de Redação (NU_NOTA_REDACAO)**.
